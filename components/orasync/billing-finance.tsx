...
export default function BillingFinance() {
  ...
  const handleExportReport = () => {
    alert("Export report dialog would open here")
  }
  ...
  const handleSendInvoice = (invoiceId: string) => {
    alert(`Send invoice ${invoiceId} to patient`)
  }
  ...
  const handleFilterInvoices = () => {
    alert("Filter invoices dialog would open here")
  }

  const handleNewInvoice = () => {
    alert("Create new invoice form would open here")
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card
          ...
          onClick={() => handleMetricClick("payments", "payments-section")}
        >
        ...
        <Card
          className="cursor-pointer hover:shadow-lg hover:scale-105 transition-all"
          onClick={() => handleMetricClick("invoices", "invoices-section")}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card
          className="cursor-pointer hover:shadow-lg hover:scale-105 transition-all"
          onClick={() => handleMetricClick("insurance", "insurance-section")}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <Card
          className="cursor-pointer hover:shadow-lg hover:scale-105 transition-all"
          onClick={() => handleMetricClick("reports", "reports-section")}
        >
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="invoices" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card
              className="cursor-pointer hover:shadow-lg hover:scale-105 transition-all"
              onClick={() => scrollToSection("invoices-section")}
            >
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              {[
                ...
                >
                  ...
                  <div className="flex gap-1">
                    <Button size="sm" variant="ghost" onClick={() => handleViewInvoice(invoice.id)}>
                      <Eye className="w-4 h-4" />
                    </Button>
                    <Button size="sm" variant="ghost" onClick={() => handleSendInvoice(invoice.id)}>
                      <Send className="w-4 h-4" />
                    </Button>
                    <Button size="sm" variant="ghost" onClick={() => handleDownloadInvoice(invoice.id)}>
        ...
        <TabsContent value="membership" className="space-y-6">
          ...
          <div id="membership-section" className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
              ...
              <CardContent className="space-y-3">
                {[
                  ...
                  <div key={index} className="flex items-center justify-between p-3 rounded-lg border">
                    ...
                    <Button size="sm" variant="ghost" onClick={() => alert(`Download ${report.name}`)}>
                      <Download className="w-4 h-4" />
                    </Button>
                  </div>
                ))}
