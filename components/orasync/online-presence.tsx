        ...
        <TabsContent value="ads" className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your advertising platforms</CardDescription>
              </CardHeader>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-medium">$19.57</div>
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex-1">
                    <p className="font-medium">Teeth Whitening Promo</p>
                    <p className="text-sm text-muted-foreground">Facebook Ads • Active</p>
                  </div>
                  <div className="text-right mr-4">
                    <div className="text-sm font-medium">$680</div>
                    <div className="text-xs text-muted-foreground">spend</div>
                  </div>
                  <div className="text-right mr-4">
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex-1">
                    <p className="font-medium">Emergency Dental Care</p>
                    <p className="text-sm text-muted-foreground">Google Ads • Paused</p>
                  </div>
                  <div className="text-right mr-4">
                  ...
                  <div className="text-right">
                    <div className="text-sm font-medium">$44.00</div>
                    <div className="text-xs text-muted-foreground">CPL</div>
                  </div>
                  <Button size="sm" variant="ghost">
                    Edit
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Import leads from ad platforms or CSV</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3">
              ...
              <div className="p-3 rounded-lg bg-muted text-sm">
                <p className="font-medium mb-2">Auto-Enrollment Settings</p>
                <div className="flex items-center justify-between">
                  <span>Auto-enroll ad leads in campaigns</span>
                  <Switch defaultChecked />
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Track which ads drive bookings</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    <p className="font-medium">Spring Cleaning Special</p>
                    <p className="text-sm text-muted-foreground">23 leads • 8 bookings</p>
                  </div>
                  <div className="text-right">
                    <div className="text-sm font-bold">34.8%</div>
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div>
                    <p className="font-medium">Teeth Whitening Promo</p>
                    <p className="text-sm text-muted-foreground">34 leads • 5 bookings</p>
                  </div>
                  <div className="text-right">
                    <div className="text-sm font-bold">14.7%</div>
                    <div className="text-xs text-muted-foreground">conversion</div>
                  </div>
                </div>
              </div>
